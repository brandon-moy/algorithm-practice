...
describe('Given a sequence of integers in an array, determine whether it is possible to obtain a strictly increasing sequence by removing no more than one element from the array', () => {
  it('Returns a boolean if description can be achieved for array of positive integers', () => {
  ...
  it('Returns a boolean if description can be achieved for array of negative integers', () => {
    const testTwo = [-1, -3, -2];
